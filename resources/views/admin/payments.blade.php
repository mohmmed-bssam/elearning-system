                            ...
                            <tbody>
                                @forelse ($payments as $payment)
                                    <tr class="bg-neutral-primary border-b border-default">
                                        ...
                                        <td class="px-6 py-4">
                                            {{ $payment->course->getTransAttribute('title') }}
                                        </td>
                                        <td class="px-6 py-4">
                                            ${{ $payment->amount }}
                                        </td>
                                        <td class="px-6 py-4">
                                            ...
                                            <span style="background:rgb(196, 140, 44);color:white;padding:5px 10px;">
                                                    Pending
                                                </span>
                                            @elseif($payment->status == 'paid')
                                                <span style="background:rgb(51, 161, 51);color:white;padding:5px 10px;">
                                                    Paid
                                                </span>
                                            @else
                                              <span style="background:rgb(194, 17, 17);color:white;padding:5px 10px;">
                                                    Failed
                                                </span>
                                            @endif
                                            <span
