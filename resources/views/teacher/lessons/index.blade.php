...
@foreach ($courses as $course)
    ...
    <div x-data="{ open: false }"
         class="bg-white shadow-md rounded-2xl overflow-hidden border border-gray-100">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('teacher.lessons.create', ['course_id' => $course->id]) }}"
        ...
        <div x-show="open"
            ...
            @forelse($course->lessons as $lesson)
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition flex justify-between items-center">
